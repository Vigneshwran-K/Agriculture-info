...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption">
          <h2 class="display-2">WELCOME TO HARVESTIFY
          </h2>
          <h3>A web platform for farmers</h3>
        </div>
      </div>
      <div class="carousel-item">
        <img src="images/red.png">
        <div class="carousel-caption">
          <h1 class="display-2">HARVESTIFY
          </h1>
          <h2>A web platform for farmers</h2>
        </div>
      </div>
      <div class="carousel-item">
  ...
  <div class="container-fluid" id="content">
    <div class="row jumbotron">
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
        <p class="lead">Welcome to HARVESTIFY. To access full feature you have to register/sign in here. </p>
      </div>
  ...
  <div class="container-fluid padding">
    <div class="row text-center padding">
      <div class="col-xs-12 col-sm-6 col-md-4">
        <h3>Prediction</h3>
        <p>Predict what crops and fertilizers can be used</p>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-4">
        <h3>Trading</h3>
        <p>Can get to know the current and eligible price</p>
      </div>
...
<a href="#" class="btn btn-primary">Learn More</a>
    ...
    <br>
    <div class="col-lg-6">
      <img src="images/cp.jpg" class="img-fluid">
